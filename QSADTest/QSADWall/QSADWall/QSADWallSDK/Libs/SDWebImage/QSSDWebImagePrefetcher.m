...
#import "QSSDWebImagePrefetcher.h"

#if !defined(DEBUG) && !defined (SD_VERBOSE)
#define NSLog(...)
#endif

@interface QSSDWebImagePrefetcher ()

@property (strong, nonatomic) QSSDWebImageManager *manager;
...
@implementation QSSDWebImagePrefetcher
...
- (id)init {
    if ((self = [super init])) {
        _manager = [QSSDWebImageManager new];
