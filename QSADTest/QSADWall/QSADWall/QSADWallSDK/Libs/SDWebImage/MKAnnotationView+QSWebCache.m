...
#import "MKAnnotationView+QSWebCache.h"
#import "objc/runtime.h"

static char imageURLKey;
static char operationKey;

@implementation MKAnnotationView (QSWebCache)
...
- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock {
    ...
    if (url) {
        ...
        id <QSSDWebImageOperation> operation = [QSSDWebImageManager.sharedManager downloadImageWithURL:url options:options progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
            if (!wself) return;
