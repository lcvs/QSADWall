...
#import "QSSDWebImageDecoder.h"
#import "UIImage+QSMultiFormat.h"
#import <ImageIO/ImageIO.h>
#import "QSSDWebImageManager.h"

@interface QSSDWebImageDownloaderOperation () {
    BOOL _executing;
    BOOL _finished;
}
...
@implementation QSSDWebImageDownloaderOperation {
    size_t width, height;
    ...
    if ((self.options & SDWebImageDownloaderProgressiveDownload) && self.expectedSize > 0 && self.completedBlock) {
        ...
        if (width + height > 0 && totalSize < self.expectedSize) {
            ...
            if (partialImageRef) {
                ...
                NSString *key = [[QSSDWebImageManager sharedManager] cacheKeyForURL:self.request.URL];
